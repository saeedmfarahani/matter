 ...
 * as the output it is assigned to. See exclusiveOutput() and
 * LOutput::sessionLockRole(). If the client does not create one for a given
 * output, the user content should be hidden; for example, by blacking out the
 * screen. */
