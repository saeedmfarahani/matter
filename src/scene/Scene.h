 ...
 *
 * It contains a mainView() and five child layer views, following the same
 * structure as the Louvre surface layers concept.
 *
 * For more details, see LSurfaceLayer and the "Order" section of the LSurface
 * class documentation.
 */
