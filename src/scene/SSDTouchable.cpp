...
SSDTouchable::SSDTouchable(SSD *ssd, ButtonType buttonType, LBitset<LEdge> edge,
                           LView *parent) noexcept
    : LSolidColorView(parent), edge(edge), buttonType(buttonType), ssd(ssd) {
